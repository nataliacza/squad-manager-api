...
@router.get(path="/{member_id}/details",
            ...
            responses={200: {"description": "Successful operation"},
                       ...
                       405: {"description": "Method Not Allowed"}})
async def get_member_details(member_id: int, session: Session = Depends(get_session)):
...
@router.put(path="/{member_id}/details",
            response_model=MemberResponseDto,
...
@router.patch(path="/{member_id}/courses/{course_id}",
...
@router.get(path="/{member_id}/courses",
            ...
            responses={200: {"description": "Successful operation"},
                       ...
                       404: {"description": "Not Found"},
                       405: {"description": "Method Not Allowed"}})
async def get_member_courses(member_id: int, session: Session = Depends(get_session)):
